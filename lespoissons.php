		...
		<div id="conteneur">
			<div class="boite">
				<h3>Anchois</h3>
					...
					<p>
								...
								<img src="./Images/Poissons/Anchois.png"/><br/> 
					...
					<p>
						<a href="#" class="parent_bulle">Informations : 
							<span class="bulle">Période : Toute l'année<br/>
								Heure : 4h - 21h<br/>
								Lieu : Océan<br/>
								Taille : Petite<br/>
								Rare
			...
			<div class="boite">
				<h3>Arapaïma</h3>
					...
					<p>
						<img src="./Images/Poissons/Arapaima.png"/><br/>
			...
			<div class="boite">
				<h3>Arowana</h3>
					...
					Prix Pollux : 15 000 clo's
					<p>
						<img src="./Images/Poissons/Arowana.png"/><br/>
			...
			<div class="boite">
				<h3>Ayu</h3>
					...
					<p>
							<img src="./Images/Poissons/Ayu.png"/><br/>
			...
			<div class="boite">
				<h3>Bar commun</h3>
					...
					Prix Pollux : 600 clo's
					<p>
							<img src="./Images/Poissons/Barcommun.png"/><br/>
			...
			<div class="boite">
				<h3>Bichir</h3>
					...
					<p>
							<img src="./Images/Poissons/Bichir.png"/><br/>
			...
			<div class="boite">
				<h3>Bouvière</h3>
					...
					Prix Pollux : 1 350 clo's
					<p>
							<img src="./Images/Poissons/Bouviere.png"/><br/>
			...
			<div class="boite">
				<h3>Brochet</h3>
					...
					<p>
							<img src="./Images/Poissons/Brochet.png"/><br/>
			...
			<div class="boite">
				<h3>Calmar</h3>
					...
					<p>
						<img src="./Images/Poissons/Calmar.png"/><br/>
			...
			<div class="boite">
				<h3>Carangue grosse tête</h3>
					...
					<p>
						<img src="./Images/Poissons/Caranguegrossetete.png"/><br/>
			...
			<div class="boite">
				<h3>Carassin</h3>
					...
					<p>
						<img src="./Images/Poissons/Carassin.png"/><br/>
			...
			<div class="boite">
				<h3>Cardeau</h3>
					...
					<p>
							<img src="./Images/Poissons/Cardeau.png"/><br/>
			...
			<div class="boite">
				<h3>Carpe</h3>
					...
					<p>
						<img src="./Images/Poissons/Carpe.png"/><br/>
			...
			<div class="boite">
				<h3>Carpekoi</h3>
					...
					Prix Pollux : 6 000 clo's
					<p>
							<img src="./Images/Poissons/CarpeKoi.png"/><br/>
			...
			<div class="boite">
				<h3>Chevaine</h3>
					...
					Prix Pollux : 240 clo's
					<p>
						<img src="./Images/Poissons/Chevaine.png"/><br/>
			...
			<div class="boite">
				<h3>Chinchard</h3>
					...
					<p>
							<img src="./Images/Poissons/Chinchard.png"/><br/>
			...
			<div class="boite">
				<h3>Clione</h3>
					...
					<p>
						<img src="./Images/Poissons/Clione.png"/><br/>
			...
			<div class="boite">
				<h3>Coelacanthe</h3>
					...
					<p>
							<img src="./Images/Poissons/Coelacanthe.png"/><br/>
			...
			<div class="boite">
				<h3>Combattant</h3>
					...
					<p>
							<img src="./Images/Poissons/Combattant.png"/><br/>
			...
			<div class="boite">
				<h3>Coryphène</h3>
					...
					<p>
						<img src="./Images/Poissons/Coryphene.png"/><br/>
			...
			<div class="boite">
				<h3>Crabe chinois</h3>
					...
					<p>
							<img src="./Images/Poissons/Crabechinois.png"/><br/>
			...
			<div class="boite">
				<h3>Crapet</h3>
					...
					<p>
						<img src="./Images/Poissons/Crapet.png"/><br/>
			...
			<div class="boite">
				<h3>Cyprin doré</h3>
					...
					<p>
						<img src="./Images/Poissons/Cyprindore.png"/><br/>
			...
			<div class="boite">
				<h3>Dai yu</h3>
					...
					Prix Pollux : 22 500 clo's
					<p>
						<img src="./Images/Poissons/Daiyu.png"/><br/>
			...
			<div class="boite">
				<h3>Dorade</h3>
					...
					Prix Pollux : 22 500 clo's
					<p>
						<img src="./Images/Poissons/Dorade.png"/><br/>
			...
			<div class="boite">
				<h3>Ecrevisse</h3>
					...
					Prix Pollux : 300 clo's
					<p>
						<img src="./Images/Poissons/Ecrevisse.png"/><br/>
			...
			<div class="boite">
				<h3>Eperlan</h3>
					...
					<p>
						<img src="./Images/Poissons/Eperlan.png"/><br/>
			...
			<div class="boite">
				<h3>Esturgeon</h3>
					...
					Prix Pollux : 15 000 clo's
					<p>
						<img src="./Images/Poissons/Esturgeon.png"/><br/>
			...
			<div class="boite">
				<h3>Fondule barré</h3>
					...
					Prix Pollux : 450 clo's
					<p>
						<img src="./Images/Poissons/Fondulebarre.png"/><br/>
			...
			<div class="boite">
				<h3>Gar</h3>
					...
					<p>
						<img src="./Images/Poissons/Gar.png"/><br/>
			...
			<div class="boite">
				<h3>Gobie d'eau douce</h3>
					...
					Prix Pollux : 600 clo's
					<p>
							<img src="./Images/Poissons/Gobiedeaudouce.png"/><br/>
			...
			<div class="boite">
				<h3>Grand requin blanc</h3>
					...
					Prix Pollux : 22 500 clo's
					<p>
							<img src="./Images/Poissons/Grandrequinblanc.png"/><br/>
			...
			<div class="boite">
				<h3>Grenouille</h3>
					...
					Prix Pollux : 180 clo's
					<p>
						<img src="./Images/Poissons/Grenouille.png"/><br/>
			...
			<div class="boite">
				<h3>Guppy</h3>
					...
					Prix Pollux : 1 950 clo's
					<p>
						<img src="./Images/Poissons/Guppy.png"/><br/>
			...
			<div class="boite">
				<h3>Hippocampe</h3>
					...
					<p>
						<img src="./Images/Poissons/Hippocampe.png"/><br/>
			...
			<div class="boite">
				<h3>Limande</h3>
					...
					Prix Pollux : 450 clo's
					<p>
						<img src="./Images/Poissons/Limande.png"/><br/>
			...
			<div class="boite">
				<h3>Loche d'étang</h3>
					...
					Prix Pollux : 450 clo's
					<p>
						<img src="./Images/Poissons/Lochedetang.png"/><br/>
			...
			<div class="boite">
				<h3>Lune de mer</h3>
					...
					Prix Pollux : 6 000 clo's
					<p>
						<img src="./Images/Poissons/Lunedemer.png"/><br/>
			...
			<div class="boite">
				<h3>Macropinna</h3>
					...
					Prix Pollux : 22 500 clo's
					<p>
						<img src="./Images/Poissons/Macropinna.png"/><br/>
			...
			<div class="boite">
				<h3>Marlin bleu</h3>
					...
					Prix Pollux : 22 500 clo's
					<p>
						<img src="./Images/Poissons/Marlinbleu.png"/><br/>
						<input type="button" name="endessous" value="-" onclick="changementmarlinbleu(-1)" />
						<span id="nummarlinbleu">0</span>
						<input type="button" name="audessus" value="+" onclick="changementmarlinbleu(+1)" />
					</p>

					<p>
						<input type="button" name="zero" value="reset" onclick="remiseazeromarlinbleu()"/>
					</p>
			</div>
			...
			<div class="boite">
				<h3>Murène</h3>
					...
					Prix Pollux : 3 000 clo's
					<p>
						<img src="./Images/Poissons/Murene.png"/><br/>
			...
			<div class="boite">
				<h3>Murène ruban bleu</h3>
					...
					<p>
							<img src="./Images/Poissons/Murenerubanbleu.png"/><br/>
			...
			<div class="boite">
				<h3>Napoleon</h3>
					...
					Prix Pollux : 15 000 clo's
					<p>
							<img src="./Images/Poissons/Napoleon.png"/><br/>
			...
			<div class="boite">
				<h3>Néon bleu</h3>
					...
					Prix Pollux : 750 clo's
					<p>
						<img src="./Images/Poissons/Neonbleu.png"/><br/>
			...
			<div class="boite">
				<h3>Omble</h3>
					...
					<p>
						<img src="./Images/Poissons/Omble.png"/><br/>
			...
			<div class="boite">
				<h3>Perche jaune</h3>
					...
					<p>
						<img src="./Images/Poissons/Perchejaune.png"/><br/>
			...
			<div class="boite">
				<h3>Piranha</h3>
					...
					Prix Pollux : 3 750 clo's
					<p>
							<img src="./Images/Poissons/Piranha.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson ange</h3>
					...
					<p>
						<img src="./Images/Poissons/Poissonange.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson arc-en-ciel</h3>
					...
					Prix Pollux : 1 200 clo's
					<p>
						<img src="./Images/Poissons/Poissonarcenciel.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson ballon</h3>
					...
					<p>
						<img src="./Images/Poissons/Poissonballon.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson chirurgien</h3>
					...
					Prix Pollux : 1 500 clo's
					<p>
						<img src="./Images/Poissons/Poissonchirurgien.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson clown</h3>
					...
					<p>
						<img src="./Images/Poissons/Poissonclown.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson docteur</h3>
					...
					<p>
						<img src="./Images/Poissons/Poissondocteur.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson lanterne</h3>
					...
					Prix Pollux : 3 750 clo's
					<p>
						<img src="./Images/Poissons/Poissonlanterne.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson papillon</h3>
					...
					Prix Pollux : 1 500 clo's
					<p>
						<img src="./Images/Poissons/Poissonpapillon.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson porc-épic</h3>
					...
					<p>
						<img src="./Images/Poissons/Poissonporcepic.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson rouge</h3>
					...
					Prix Pollux : 1 950 clo's
					<p>
						<img src="./Images/Poissons/Poissonrouge.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson ruban</h3>
					...
					<p>
						<img src="./Images/Poissons/Poissonruban.png"/><br/>
			...
			<div class="boite">
				<h3>Poisson scorpion</h3>
					...
					Prix Pollux : 750 clo's
					<p>
						<img src="./Images/Poissons/Poissonscorpion.png"/><br/>
			...
			<div class="boite">
				<h3>Raie</h3>
					...
					Prix Pollux : 4 500 clo's
					<p>
						<img src="./Images/Poissons/Raie.png"/><br/>
			...
			<div class="boite">
				<h3>Ranchu</h3>
					...
					Prix Pollux : 6 750 clo's
					<p>
						<img src="./Images/Poissons/Ranchu.png"/><br/>
			...
			<div class="boite">
				<h3>Rémora rayé</h3>
					...
					Prix Pollux : 2 250 clo's
					<p>
						<img src="./Images/Poissons/Remoraraye.png"/><br/>
			...
			<div class="boite">
				<h3>Requin baleine</h3>
					...
					<p>
						<img src="./Images/Poissons/Requinbaleine.png"/><br/>
			...
			<div class="boite">
				<h3>Requin marteau</h3>
					...
					<p>
						<img src="./Images/Poissons/Requinmarteau.png"/><br/>
			...
			<div class="boite">
				<h3>Requin scie</h3>
					...
					Prix Pollux : 18 000 clo's
					<p>
							<img src="./Images/Poissons/Requinscie.png"/><br/>
			...
			<div class="boite">
				<h3>Saumon</h3>
					...
					<p>
						<img src="./Images/Poissons/Saumon.png"/><br/>
			...
			<div class="boite">
				<h3>Saumon masou</h3>
					...
					Prix Pollux : 1 500 clo's
					<p>
						<img src="./Images/Poissons/Saumonmasou.png"/><br/>
			...
			<div class="boite">
				<h3>Saumon roi</h3>
					...
					Prix Pollux : 2 700 clo's
					<p>
						<img src="./Images/Poissons/Saumonroi.png"/><br/>
			...
			<div class="boite">
				<h3>Scarus</h3>
					...
					Prix Pollux : 7 500 clo's
					<p>
						<img src="./Images/Poissons/Scarus.png"/><br/>
			...
			<div class="boite">
				<h3>Silure</h3>
					...
					Prix Pollux : 1 200 clo's
					<p>
						<img src="./Images/Poissons/Silure.png"/><br/>
			...
			<div class="boite">
				<h3>Têtard</h3>
					...
					Prix Pollux : 180 clo's
					<p>
						<img src="./Images/Poissons/Tetard.png"/><br/>
			...
			<div class="boite">
				<h3>Tête de serpent</h3>
					...
					<p>
						<img src="./Images/Poissons/Tetedeserpent.png"/><br/>
			...
			<div class="boite">
				<h3>Thon</h3>
					...
					<p>
						<img src="./Images/Poissons/Thon.png"/><br/>
			...
			<div class="boite">
				<h3>Tilapia</h3>
					...
					Prix Pollux : 1 200 clo's
					<p>
							<img src="./Images/Poissons/Tilapia.png"/><br/>
			...
			<div class="boite">
				<h3>Tortue serpentine</h3>
					...
					Prix Pollux : 7 500 clo's
					<p>
						<img src="./Images/Poissons/Tortueserpentine.png"/><br/>
			...
			<div class="boite">
				<h3>Tortue trionyx</h3>
					...
					<p>
						<img src="./Images/Poissons/Tortuetrionyx.png"/><br/>
			...
			<div class="boite">
				<h3>Truite dorée</h3>
					...
					Prix Pollux : 22 500 clo's
					<p>
						<img src="./Images/Poissons/Truitedoree.png"/><br/>
			...
			<div class="boite">
				<h3>Vandoise</h3>
					...
					Prix Pollux : 360 clo's
					<p>
						<img src="./Images/Poissons/Vandoise.png"/><br/>
			...
			<div class="boite">
				<h3>Vivaneau</h3>
					...
					Prix Pollux : 4 500 clo's
					<p>
							<img src="./Images/Poissons/Vivaneau.png"/><br/>
